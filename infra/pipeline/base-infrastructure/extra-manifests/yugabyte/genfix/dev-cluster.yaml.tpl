...
kind: ScaledObject
metadata:
  name: genfix-dev-tserver-scaledobject
  namespace: yb
  labels:
    app.kubernetes.io/name: genfix-dev-tserver-scaledobject
...
kind: ScaledObject
metadata:
  name: genfix-dev-cpu-scaledobject
  namespace: yb
  labels:
    app.kubernetes.io/name: genfix-dev-cpu-scaledobject
    app.kubernetes.io/component: autoscaling
    app.kubernetes.io/part-of: keda
spec:
  scaleTargetRef:
...
kind: ScaledObject
metadata:
  name: genfix-dev-memory-scaledobject
  namespace: yb
  labels:
    app.kubernetes.io/name: genfix-dev-memory-scaledobject
    app.kubernetes.io/component: autoscaling
    app.kubernetes.io/part-of: keda
spec:
  scaleTargetRef:
