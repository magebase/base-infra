...
spec:
  ...
  tls:
    ...
    certManager:
      ...
      dnsNames:
      - genfix-qa-cluster.yb.svc.cluster.local
  ...
  backup:
    ...
    storage:
      type: s3
      bucket: genfix-qa-yugabyte-backups
      region: auto
...
kind: ScaledObject
metadata:
  name: genfix-qa-cpu-scaledobject
  namespace: yb
  labels:
    app.kubernetes.io/name: genfix-qa-cpu-scaledobject
...
kind: ScaledObject
metadata:
  name: genfix-qa-memory-scaledobject
  namespace: yb
  labels:
    app.kubernetes.io/name: genfix-qa-memory-scaledobject
    app.kubernetes.io/component: autoscaling
    app.kubernetes.io/part-of: keda
spec:
  scaleTargetRef:
