...
spec:
  ...
  tls:
    ...
    certManager:
      ...
      dnsNames:
      - genfix-uat-cluster.yb.svc.cluster.local
  ...
  backup:
    ...
    storage:
      type: s3
      bucket: genfix-uat-yugabyte-backups
      region: auto
...
kind: ScaledObject
metadata:
  name: genfix-uat-cpu-scaledobject
  namespace: yb
  labels:
    app.kubernetes.io/name: genfix-uat-cpu-scaledobject
...
kind: ScaledObject
metadata:
  name: genfix-uat-memory-scaledobject
  namespace: yb
  labels:
    app.kubernetes.io/name: genfix-uat-memory-scaledobject
    app.kubernetes.io/component: autoscaling
    app.kubernetes.io/part-of: keda
spec:
  scaleTargetRef:
