...
spec:
  ...
  tls:
    ...
    certManager:
      ...
      dnsNames:
      - genfix-prod-cluster.yb.svc.cluster.local
  ...
  backup:
    ...
    storage:
      type: s3
      bucket: genfix-prod-yugabyte-backups
      region: auto
...
kind: ScaledObject
metadata:
  name: genfix-prod-cpu-scaledobject
  namespace: yb
  labels:
    app.kubernetes.io/name: genfix-prod-cpu-scaledobject
...
kind: ScaledObject
metadata:
  name: genfix-prod-memory-scaledobject
  namespace: yb
  labels:
    app.kubernetes.io/name: genfix-prod-memory-scaledobject
    app.kubernetes.io/component: autoscaling
    app.kubernetes.io/part-of: keda
spec:
  scaleTargetRef:
