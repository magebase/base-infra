...
spec:
  ...
  tls:
    ...
    certManager:
      ...
      dnsNames:
      - site-dev-cluster.yb.svc.cluster.local
  ...
  backup:
    ...
    storage:
      type: s3
      bucket: site-dev-yugabyte-backups
      region: auto
...
kind: ScaledObject
metadata:
  name: site-dev-tserver-scaledobject
  namespace: yb
  labels:
    app.kubernetes.io/name: site-dev-tserver-scaledobject
...
kind: ScaledObject
metadata:
  name: site-dev-cpu-scaledobject
  namespace: yb
  labels:
    app.kubernetes.io/name: site-dev-cpu-scaledobject
    app.kubernetes.io/component: autoscaling
    app.kubernetes.io/part-of: keda
spec:
  scaleTargetRef:
...
kind: ScaledObject
metadata:
  name: site-dev-memory-scaledobject
  namespace: yb
  labels:
    app.kubernetes.io/name: site-dev-memory-scaledobject
    app.kubernetes.io/component: autoscaling
    app.kubernetes.io/part-of: keda
spec:
  scaleTargetRef:
