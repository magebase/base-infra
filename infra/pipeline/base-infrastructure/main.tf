...
module "kube-hetzner" {
  ...
  k3s_exec_server_args = "--kube-apiserver-arg enable-admission-plugins=PodTolerationRestriction,PodNodeSelector --kube-apiserver-arg audit-log-path=/var/log/kubernetes/audit.log --kube-apiserver-arg audit-log-maxage=30 --kube-apiserver-arg audit-log-maxbackup=10 --kube-apiserver-arg audit-log-maxsize=100 --secrets-encryption=true"
