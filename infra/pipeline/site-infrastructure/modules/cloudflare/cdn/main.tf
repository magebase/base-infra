...
# NOTE: cloudflare_page_rule is deprecated in provider v5, replaced with cloudflare_ruleset
...
# NOTE: cloudflare_ruleset syntax changed in provider v5, needs further investigation
