...
database_url = "postgresql://magebase_admin:your_password_here@magebase-postgres.cluster-xxxxxx.ap-southeast-2.rds.amazonaws.com:5432/magebase_uat"

# Cache Configuration
# SolidCache uses PostgreSQL for caching (can use same as database_url or separate)
cache_database_url = "postgresql://magebase_admin:your_password_here@magebase-postgres.cluster-xxxxxx.ap-southeast-2.rds.amazonaws.com:5432/magebase_uat"

# Rails Application Secrets
# Secret key base for Rails sessions and encrypted cookies
secret_key_base = "your-uat-secret-key-base-here-32-characters-minimum"
